    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          className,
          // After consumer className so hover label color wins over text-* utilities
          showFill &&
            "!text-[var(--ob-label-on-fill,#020617)]",
        )}
      ...
      >
        <motion.span
          ...
          aria-hidden
          className="pointer-events-none absolute -translate-x-1/2 -translate-y-1/2 rounded-full bg-[var(--ob-fill,var(--color-foreground))]"
          initial={false}
          style={{
            height: coverSize,
            left: origin.x,
