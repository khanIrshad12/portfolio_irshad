...
/** Compact mobile experience card — no ContainerScroll / 3D height theater */
    ...
    <article className="w-full">
      ...
      >
        <div className="mb-4 flex flex-wrap items-start justify-between gap-3 border-b border-white/10 pb-4">
          ...
          <div className="flex w-full flex-col gap-2 rounded-lg border border-white/5 bg-white/[0.03] px-3 py-2.5 font-mono text-[11px] text-white/55 sm:w-auto">
